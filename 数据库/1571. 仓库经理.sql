...
select name as warehouse_name, sum(vol_all) as volume
from
(
    select name, a.units*b.vol as vol_all
    from Warehouse a join 
    (select product_id, Width*Length*Height as vol from Products) b
