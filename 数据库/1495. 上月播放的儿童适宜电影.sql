...
select a.title  from Content a join TVProgram b using(content_id) where a.Kids_content = 'Y' and b.program_date like '2020-06%' and a.content_type = 'Movies' group by a.title